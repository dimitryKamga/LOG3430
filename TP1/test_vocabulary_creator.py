...
class TestVocabularyCreator(unittest.TestCase):
    ...
    def test_write_data_to_vocab_file_returns_false(self):
        vc_ = VocabularyCreator()
        vc_.vocabulary = []
        self.assertEqual(vc_.write_data_to_vocab_file(self.vocab_expected), False)

    def test_write_data_to_vocab_file_return_true(self):
        vc_ = VocabularyCreator()
    ...
    def test_clean_text_should_return_text (self, mock_clean_text):
        vc_ = VocabularyCreator()
