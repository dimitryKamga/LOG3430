...
class TestMain(unittest.TestCase):
    ...
    def test_clean_emails_train_set(self):
        print("----------test_clean_train_set----------")
        self.prepareVocab("train_clean.json")
        accuracy=evaluate("test300.json")
        self.assertLessEqual(abs(self.initialAccuracyTest-accuracy),0.03)
        
    def test_clean_emails_test_set(self):
        print("----------test_clean_test_set----------")
        self.prepareVocab("train700.json")
        accuracy=evaluate("test_clean.json")
        self.assertLessEqual(abs(self.initialAccuracyTest-accuracy),0.03)
    ...
    def test_duplication_words_train_set(self):
        print("----------test_duplication_words_train_set----------")
        self.prepareVocab("train_words.json")
        accuracy=evaluate("test300.json")
        self.assertLessEqual(abs(self.initialAccuracyTest-accuracy),0.03)

    def test_duplication_words_test_set(self):
        print("----------test_duplication_words_test_set----------")
        self.prepareVocab("train700.json")
        accuracy=evaluate("test_words.json")
        self.assertLessEqual(abs(self.initialAccuracyTest-accuracy),0.03)
